...
ELUOp_CPU<float> ELU1 = ELUOp_CPU<float>(1);
...
ELUOp_CPU<float> ELU2 = ELUOp_CPU<float>(1);
...
ELUOp_CPU<float> ELU3 = ELUOp_CPU<float>(1);
...
ELUOp_CPU<float> deconv5_1_ELU = ELUOp_CPU<float>(1);
...
ELUOp_CPU<float> deconv5_2_ELU = ELUOp_CPU<float>(1);
