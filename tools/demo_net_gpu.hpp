...
private:
    ...
    MIOpenBatchNormOp_GPU<float> bn1 = MIOpenBatchNormOp_GPU<float> (8388608, 1, 32, 1e-05, 1, false, NULL, NULL, bn1_weight, bn1_bias);
    ...
    MIOpenBatchNormOp_GPU<float> bn2 = MIOpenBatchNormOp_GPU<float> (4194304, 1, 64, 1e-05, 1, false, NULL, NULL, bn2_weight, bn2_bias);
    ...
    MIOpenBatchNormOp_GPU<float> bn3 = MIOpenBatchNormOp_GPU<float> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, bn3_weight, bn3_bias);
    ...
    MIOpenBatchNormOp_GPU<float> res1_bn1 = MIOpenBatchNormOp_GPU<float> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res1_bn1_weight, res1_bn1_bias);
    ...
    MIOpenBatchNormOp_GPU<float> res1_bn2 = MIOpenBatchNormOp_GPU<float> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res1_bn2_weight, res1_bn2_bias);
    ...
    MIOpenBatchNormOp_GPU<float> res2_bn1 = MIOpenBatchNormOp_GPU<float> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res2_bn1_weight, res2_bn1_bias);
    ...
    MIOpenBatchNormOp_GPU<float> res2_bn2 = MIOpenBatchNormOp_GPU<float> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res2_bn2_weight, res2_bn2_bias);
    ...
    MIOpenBatchNormOp_GPU<float> res3_bn1 = MIOpenBatchNormOp_GPU<float> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res3_bn1_weight, res3_bn1_bias);
    ...
    MIOpenBatchNormOp_GPU<float> res3_bn2 = MIOpenBatchNormOp_GPU<float> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res3_bn2_weight, res3_bn2_bias);
    ...
    MIOpenBatchNormOp_GPU<float> res4_bn1 = MIOpenBatchNormOp_GPU<float> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res4_bn1_weight, res4_bn1_bias);
    ...
    MIOpenBatchNormOp_GPU<float> res4_bn2 = MIOpenBatchNormOp_GPU<float> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res4_bn2_weight, res4_bn2_bias);
    ...
    MIOpenBatchNormOp_GPU<float> res5_bn1 = MIOpenBatchNormOp_GPU<float> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res5_bn1_weight, res5_bn1_bias);
    ...
    MIOpenBatchNormOp_GPU<float> res5_bn2 = MIOpenBatchNormOp_GPU<float> (2097152, 1, 128, 1e-05, 1, false, NULL, NULL, res5_bn2_weight, res5_bn2_bias);
    ...
    MIOpenBatchNormOp_GPU<float> de_bn1 = MIOpenBatchNormOp_GPU<float> (4194304, 1, 64, 1e-05, 1, false, NULL, NULL, de_bn1_weight, de_bn1_bias);
    ...
    MIOpenBatchNormOp_GPU<float> de_bn2 = MIOpenBatchNormOp_GPU<float> (8388608, 1, 32, 1e-05, 1, false, NULL, NULL, de_bn2_weight, de_bn2_bias);
