...
BatchNormOp_GPU<float> bn1 = BatchNormOp_GPU<float>( 8388608, 1, 32, 1e-05, 0.50025, false, NULL, NULL);
...
BatchNormOp_GPU<float> bn2 = BatchNormOp_GPU<float>( 4194304, 1, 64, 1e-05, 0.50025, false, NULL, NULL);
...
BatchNormOp_GPU<float> bn3 = BatchNormOp_GPU<float>( 2097152, 1, 128, 1e-05, 0.50025, false, NULL, NULL);
...
BatchNormOp_GPU<float> res1_bn1 = BatchNormOp_GPU<float>( 2097152, 1, 128, 1e-05, 0.50025, false, NULL, NULL);
...
BatchNormOp_GPU<float> res1_bn2 = BatchNormOp_GPU<float>( 2097152, 1, 128, 1e-05, 0.50025, false, NULL, NULL);
...
BatchNormOp_GPU<float> res2_bn1 = BatchNormOp_GPU<float>( 2097152, 1, 128, 1e-05, 0.50025, false, NULL, NULL);
...
BatchNormOp_GPU<float> res2_bn2 = BatchNormOp_GPU<float>( 2097152, 1, 128, 1e-05, 0.50025, false, NULL, NULL);
...
BatchNormOp_GPU<float> res3_bn1 = BatchNormOp_GPU<float>( 2097152, 1, 128, 1e-05, 0.50025, false, NULL, NULL);
...
BatchNormOp_GPU<float> res3_bn2 = BatchNormOp_GPU<float>( 2097152, 1, 128, 1e-05, 0.50025, false, NULL, NULL);
...
BatchNormOp_GPU<float> res4_bn1 = BatchNormOp_GPU<float>( 2097152, 1, 128, 1e-05, 0.50025, false, NULL, NULL);
...
BatchNormOp_GPU<float> res4_bn2 = BatchNormOp_GPU<float>( 2097152, 1, 128, 1e-05, 0.50025, false, NULL, NULL);
...
BatchNormOp_GPU<float> res5_bn1 = BatchNormOp_GPU<float>( 2097152, 1, 128, 1e-05, 0.50025, false, NULL, NULL);
...
BatchNormOp_GPU<float> res5_bn2 = BatchNormOp_GPU<float>( 2097152, 1, 128, 1e-05, 0.50025, false, NULL, NULL);
...
BatchNormOp_GPU<float> deconv5_1_bn = BatchNormOp_GPU<float>( 4194304, 1, 64, 1e-05, 0.50025, false, NULL, NULL);
...
BatchNormOp_GPU<float> deconv5_2_bn = BatchNormOp_GPU<float>( 8388608, 1, 32, 1e-05, 0.50025, false, NULL, NULL);
