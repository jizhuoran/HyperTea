...
ReLUOp_CPU<float> res1_ReLU1 = ReLUOp_CPU<float>( 0);
...
ReLUOp_CPU<float> res2_ReLU1 = ReLUOp_CPU<float>( 0);
...
ReLUOp_CPU<float> res3_ReLU1 = ReLUOp_CPU<float>( 0);
...
ReLUOp_CPU<float> res4_ReLU1 = ReLUOp_CPU<float>( 0);
...
ReLUOp_CPU<float> res5_ReLU1 = ReLUOp_CPU<float>( 0);
...
TanHOp_CPU<float> tanh = TanHOp_CPU<float>( );
