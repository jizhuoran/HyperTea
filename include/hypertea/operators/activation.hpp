...
public:
    explicit ReLUOp(float negative_slope, bool inplace = false) : negative_slope_(negative_slope), inplace_(inplace) {}
...
public:
    explicit TanHOp(bool inplace = false) : inplace_(inplace) {}
...
public:
    ...
    explicit ELUOp(float alpha, bool inplace = false) : alpha_(alpha), inplace_(inplace) {}
