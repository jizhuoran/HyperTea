#ifndef HYPERTEA_HRNN_OP_HPP_
#define HYPERTEA_HRNN_OP_HPP_
...
RNNCell<DeviceTensor>* cell_factory_(
    ...
    HRNN_CELL_TYPE cell_type) {

  switch (cell_type) {
    case HRNN_CELL_TYPE::GRU_CELL: {
      return new hypertea::GRUCell<DeviceTensor>(input_dim, hidden_dim, w_ih, w_hh, b_ih, b_hh);
    }
    case HRNN_CELL_TYPE::LSTM_CELL: {
